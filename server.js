  ...
  pastWork: [
    {
      ...
      duration: "3 years",
      description:
        "Successfully opened up a number of franchise locations across the New York City area.",
    },
    {
      id: 2,
      project: "Mix and Sip",
      ...
      duration: "8 months",
      description:
        "Partnering with vendors to bring a stable blend of popular refreshments.",
    },
    {
      id: 3,
      ...
      duration: "6 months",
      description:
        "Engaging with the user base to establish connections and foot traffic.",
    },
  ],
